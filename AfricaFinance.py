...
st.markdown("<h1 style = 'text_align: center; font-family: helvetica; color: #1F4172;'> FINANCIAL INCLUSION IN AFRICA </h1>", unsafe_allow_html=True)
...
st.image('pngwing.com (10).png', width = 350, use_column_width = True)
st.markdown("<br>", unsafe_allow_html = True)
